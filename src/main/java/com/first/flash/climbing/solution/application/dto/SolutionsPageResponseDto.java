...
public record SolutionsPageResponseDto(List<MemberSolutionGroupDto> mySolutions, Meta meta) {

    public static SolutionsPageResponseDto of(
        final List<MemberSolutionGroupDto> solutions, final String nextCursor) {
